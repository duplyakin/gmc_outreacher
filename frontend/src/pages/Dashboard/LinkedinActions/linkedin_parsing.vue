        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col-6" v-if="modified_fields['total_pages']">
                <h5 class="title">Crawl the first X pages</h5>
                <el-input-number v-model="campaign_data.data.total_pages" placeholder="ex: 100.00" :min="1" :max="1000000"></el-input-number>
              </div>

              <div class="col-6" v-if="modified_fields['interval_pages']">
                <h5 class="title">Number of pages per launch (20 recommended)</h5>
