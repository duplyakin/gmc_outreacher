...
const CURRENT_PATH = "/campaign_data_form_accounts";
...
export default {
  ...
  data() {
    return {
      ...
      next_step: '/campaign_data_form_settings', // expected default value
      previous_step: '/campaign_data_form_sequence', // expected default value
