...
const CURRENT_PATH = "/campaign_data_form_sn_accounts";
...
export default {
  ...
  data() {
    return {
      ...
      next_step: '/campaign_data_form_sn_settings', // expected default value
      previous_step: '/campaign_data_form_sn_sequence', // expected default value
