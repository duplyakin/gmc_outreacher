...
const CURRENT_PATH = "/campaign_data_form_leads";
...
export default {
  ...
  data() {
    return {
      ...
      next_step: '/campaign_data_form_post_sequence', // expected default value
      previous_step: '/campaign_data_form_type', // expected default value
