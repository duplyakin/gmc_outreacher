import axios from "@/api/axios-auth";
    ...
    return axios
      ...
      .then(res => {
        ...
        if (Object.prototype.hasOwnProperty.call(r, "error") && r.error !== 0) {
          ...
          if (Object.prototype.hasOwnProperty.call(r, 'previous_step') && r.previous_step) {
    ...
    return axios
      ...
      .then(res => {
        ...
        if (Object.prototype.hasOwnProperty.call(r, "error") && r.error !== 0) {
          ...
          if (Object.prototype.hasOwnProperty.call(r, 'action')) {
          ...
          if (Object.prototype.hasOwnProperty.call(r, 'list_data')) {
  ...
  function deserialize_campaign(campaign_data, data) {
    ...
    for (let key in campaign_dict) {
      if (Object.prototype.hasOwnProperty.call(campaign_data, key) && campaign_dict[key]) {
  ...
  function deserialize_list_data(list_data, from_data) {
    ...
    for (let key in from_data) {
      if (Object.prototype.hasOwnProperty.call(list_data, key) && from_data[key]) {
