...
if TEST_DATA_FILE == 'test_data':
    print("You should use test_data_production NOT test_data")
    exit(0)
...
class TestUsersCampaignsProspects(unittest.TestCase):
    ...
    def test_1_create_models(self):
        ...
        for setting in GOOGLE_APP_SETTINGS_PRODUCTION:
            s = GoogleAppSetting()
...
def setUpModule():
    ...
    assert env == "Production", "ERROR: Must be Production environment. APP_ENV={0}".format(env)
