...
LINKEDIN_PARSING_CAMPAIGN_TYPE = 1              #Linkedin basic search parsing
LINKEDIN_ENRICHMENT_CAMPAIGN_TYPE = 2           #DEPRICATED, not used anymore need to remove
LINKEDIN_POST_PARSING_CAMPAIGN_TYPE = 3         #Linkedin post parsing
LINKEDIN_SN_PARSING_CAMPAIGN_TYPE = 4           #Linkedin SB search parsing
LINKEDIN_GROUPS_PARSING_CAMPAIGN_TYPE = 5       #Linkedin Groups parsing campaign



#Arrays for requests
OUTREACH_CAMPAIGNS = [OUTREACH_CAMPAIGN_TYPE]
ENRICHMENT_CAMPAIGNS = [LINKEDIN_PARSING_CAMPAIGN_TYPE,
                        LINKEDIN_POST_PARSING_CAMPAIGN_TYPE,
                        LINKEDIN_SN_PARSING_CAMPAIGN_TYPE,
                        LINKEDIN_GROUPS_PARSING_CAMPAIGN_TYPE]
